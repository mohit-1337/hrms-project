...
DATABASES = {
        'default': {
            ...
            'CLIENT': {
                # If using MongoDB Atlas, paste your string inside quotes below:
                # 'host': 'mongodb+srv://<username>:<password>@cluster0.mongodb.net/?retryWrites=true&w=majority',
                
                # If using Local MongoDB, use this:
